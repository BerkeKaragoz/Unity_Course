...
public class Asteroid : MonoBehaviour
{
    ...
    private void IncreaseScore()
    {
        switch (size)
        {
            case 1: ScoreGT.gameScore += 400; break;
            case 2: ScoreGT.gameScore += 200; break;
            case 3: ScoreGT.gameScore += 100; break;
            default: Debug.Log("SCORE ERROR: Undefined asteroid size. (Size =" + size + " )"); break;
        }
    }
